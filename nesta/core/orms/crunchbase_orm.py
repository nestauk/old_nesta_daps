...
class Organization(Base):
    ...
    location_id = Column(VARCHAR(400, collation='utf8mb4_unicode_ci'), index=True)
    country = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    country_code = Column(VARCHAR(3, collation='utf8mb4_unicode_ci'))
    ...
    alias1 = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    alias2 = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    alias3 = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    created_at = Column(DATETIME)
    updated_at = Column(DATETIME)
    primary_role = Column(VARCHAR(50))
    type = Column(VARCHAR(50))
    legal_name = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    total_funding = Column(BIGINT)
    total_funding_currency_code = Column(VARCHAR(3))
    num_exits = Column(INT)
    postal_code = Column(VARCHAR(3, collation='utf8mb4_unicode_ci'))
    rank = Column(BIGINT)
...
class Acquisition(Base):
    ...
    acquiree_name = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    acquiree_country_code = Column(VARCHAR(3))
    state_code = Column(VARCHAR(2))
    acquiree_region = Column(VARCHAR(50, collation='utf8mb4_unicode_ci'))
    acquiree_city = Column(VARCHAR(50, collation='utf8mb4_unicode_ci'))
    acquirer_name = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
...
class Fund(Base):
    ...
    fund_name = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    announced_on = Column(DATE)
    raised_amount = Column(BIGINT)
    raised_amount_currency_code = Column(VARCHAR(3))
    created_at = Column(DATETIME)
...
class Ipo(Base):
    ...
    name = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
...
class People(Base):
    ...
    id = Column(VARCHAR(36), primary_key=True)
    first_name = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
    last_name = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
    location_id = Column(VARCHAR(400, collation='utf8mb4_unicode_ci'), index=True)
    country = Column(VARCHAR(200, collation='utf8mb4_unicode_ci'))
    state_code = Column(VARCHAR(2))
    city = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
    ...
    facebook_url = Column(TEXT)
    linkedin_url = Column(TEXT)
    primary_affiliation_organization = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
    primary_affiliation_title = Column(VARCHAR(100, collation='utf8mb4_unicode_ci'))
