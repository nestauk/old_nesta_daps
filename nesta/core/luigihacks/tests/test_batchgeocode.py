...
@mock.patch('nesta.core.luigihacks.batchgeocode.insert_data')
@mock.patch('nesta.core.luigihacks.batchgeocode.db_session')
...
@mock.patch('nesta.core.luigihacks.batchgeocode.time.time')
...
@mock.patch('nesta.core.luigihacks.batchgeocode.boto3')
@mock.patch('nesta.core.luigihacks.batchgeocode.try_until_allowed')
@mock.patch('nesta.core.luigihacks.batchgeocode.get_mysql_engine')
