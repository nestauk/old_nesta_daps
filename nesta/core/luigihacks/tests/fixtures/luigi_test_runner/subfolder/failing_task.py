...
class RootTask(luigi.WrapperTask):
    ...
    def requires(self):
        ...
        return FailingTask(date=self.date, test=True)


class FailingTask(luigi.Task):
    """This task fails by raising an error.
    ...
    def output(self):
        ...
        update_id = "FailingTestTask_{}".format(self.date)
        return MySqlTarget(update_id=update_id, **db_config)

    def run(self):
        raise NotImplementedError("This test has deliberately failed")
