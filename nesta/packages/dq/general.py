...
def missing_values(input):
    ...
    Returns:
        missing_count_df (:obj:`pandas.core.series.Series`): A series of column nme (index) and missing value frequency (column)
...
def melt_dict_to_df(calc_dict):
    ...
    Returns:
        heat_Df (:obj:`tuple`): A dataframe with the elements of the tuple keys as indices and columns and the values as the dictionary values.
